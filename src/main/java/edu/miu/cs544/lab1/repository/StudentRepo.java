package edu.miu.cs544.lab1.repository;
...
public class StudentRepo {
    ...
    public List<Course> getCoursesByStudentId(int studentId) {
        return List.of(Objects.requireNonNull(students.stream().filter(student -> student.getId() == studentId).findFirst().map(Student::getCoursesTaken).orElse(null)));
    }
}
